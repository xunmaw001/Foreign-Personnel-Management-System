<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人口移送" prop="renkouyisong">
          <el-input v-model="ruleForm.renkouyisong" 
              placeholder="人口移送" clearable  :readonly="ro.renkouyisong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="人口移送" prop="renkouyisong">
              <el-input v-model="ruleForm.renkouyisong" 
                placeholder="人口移送" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='renkouyisong'){
            this.ruleForm.renkouyisong = obj[o];
	    this.ro.renkouyisong = true;
            continue;
          }
	                    }
                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `renkouyisong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.renkouyisongCrossAddOrUpdateFlag = false;
                  this.parent.search();
