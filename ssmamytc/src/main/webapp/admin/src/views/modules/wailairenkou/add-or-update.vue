          ...
          <el-form-item class="input" label="文化程度" prop="wenhuachengdu">
              <el-input v-model="ruleForm.wenhuachengdu" 
                placeholder="文化程度" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="血型" prop="xuexing">
          <el-input v-model="ruleForm.xuexing" 
              placeholder="血型" clearable  :readonly="ro.xuexing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="血型" prop="xuexing">
              <el-input v-model="ruleForm.xuexing" 
                placeholder="血型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="健康状况" prop="jiankangzhuangkuang">
              <el-input v-model="ruleForm.jiankangzhuangkuang" 
                placeholder="健康状况" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="暂住地址" prop="zanzhudizhi">
          <el-input v-model="ruleForm.zanzhudizhi" 
              placeholder="暂住地址" clearable  :readonly="ro.zanzhudizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="暂住地址" prop="zanzhudizhi">
              <el-input v-model="ruleForm.zanzhudizhi" 
                placeholder="暂住地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="户籍所在地" prop="hujisuozaidi">
          <el-input v-model="ruleForm.hujisuozaidi" 
              placeholder="户籍所在地" clearable  :readonly="ro.hujisuozaidi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="户籍所在地" prop="hujisuozaidi">
              <el-input v-model="ruleForm.hujisuozaidi" 
                placeholder="户籍所在地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.hunyinzhuangkuang = true;
            continue;
	            	            ...
	            	            if(o=='wenhuachengdu'){
            this.ruleForm.wenhuachengdu = obj[o];
	    this.ro.wenhuachengdu = true;
            continue;
          }
	            	            if(o=='xuexing'){
	    ...
	    this.ro.jiankangzhuangkuang = true;
            continue;
	            	            ...
	            	            if(o=='zanzhudizhi'){
            this.ruleForm.zanzhudizhi = obj[o];
	    this.ro.zanzhudizhi = true;
            continue;
          }
	            	            if(o=='hujisuozaidi'){
            this.ruleForm.hujisuozaidi = obj[o];
	    this.ro.hujisuozaidi = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                                                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                            ...
                                                                            this.hunyinzhuangkuangOptions = "已婚,未婚".split(',')
                                                                                                                                                                            },
                                                                                                                                        // 多级联动参数
                                                                                                                                                                            info(id) {
      this.$http({
        url: `wailairenkou/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `wailairenkou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wailairenkouCrossAddOrUpdateFlag = false;
                  this.parent.search();
